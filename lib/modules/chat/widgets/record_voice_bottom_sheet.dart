...
import 'package:flutter_telegram_clone/modules/chat/controllers/cretae_voice_controller.dart';
  ...
  Widget build(BuildContext context) {
    return GetBuilder(
      ...
      builder: (buildController) {
        return buildController.isRecordFinish? const PreViewVoiceWidget() :Padding(
          ...
          child : Column(
            ...
            children: [
              ...
              const H(10),
              Text("۰۰:۴۲",style: context.textTheme.titleLarge),
              const H(30),
            ],
          ),
        );
